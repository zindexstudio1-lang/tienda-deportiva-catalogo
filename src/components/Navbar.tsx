...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/90 backdrop-blur-md">
      ...
      <div 
        className={`md:hidden fixed top-0 right-0 w-[85%] max-w-sm h-full bg-white z-50 shadow-2xl transition-transform duration-300 ease-in-out flex flex-col pt-20 ${
